...
The latest verified public desktop release is **v0.088**. The current **main** development build is **v0.090**.

- **[Windows x64 — Hash Race v0.088](https://github.com/1freetech/HashRace/releases/download/v0.088/HashRace-v0.088-windows-x64.zip)**
- **[Linux x64 — Hash Race v0.088](https://github.com/1freetech/HashRace/releases/download/v0.088/HashRace-v0.088-linux-x64.tar.gz)**
- **[Hash Race v0.088 release page](https://github.com/1freetech/HashRace/releases/tag/v0.088)**

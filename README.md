...
The latest verified public desktop release is **v0.087**. The current **main** development build is **v0.088**.

- **[Windows x64 — Hash Race v0.087](https://github.com/1freetech/HashRace/releases/download/v0.087/HashRace-v0.087-windows-x64.zip)**
- **[Linux x64 — Hash Race v0.087](https://github.com/1freetech/HashRace/releases/download/v0.087/HashRace-v0.087-linux-x64.tar.gz)**
- **[Hash Race v0.087 release page](https://github.com/1freetech/HashRace/releases/tag/v0.087)**

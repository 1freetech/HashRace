...
def main():
    ...
    # v0.124 is a retained inheritance-layer contract. The live scene must boot
    # the current release world rather than being pinned forever to world_v124.
    ...
    print("Hash Race v0.124 visual-match contract: PASS through %s" % live_world)

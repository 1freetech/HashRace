...
int main(){
 ...
 // Historical release inheritance contracts formerly implemented as Python files.
 ...
 // Current gameplay chain and high-value gameplay contracts.
 ...
 const auto negotiation=read("Godot/scripts/world_negotiation.gd");
 need(negotiation.find("THREATEN")==std::string::npos,"THREATEN must remain removed from negotiation");
 // Resource/data contracts.
 ...
 // Authored visual assets protected by the old v112-v128 Python contracts.
 ...
 // Ensure Python contracts cannot silently return to CI.
